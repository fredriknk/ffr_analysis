...
class Polygon(object):
    ...
    def plot(self, text=None, textkwargs= {}, **kwargs):
        ...
        if not(text is None):
            if 'horizontalalignment' not in textkwargs:
                textkwargs['horizontalalignment'] = 'center'
            if 'verticalalignment' not in textkwargs:
                textkwargs['verticalalignment'] = 'center'
            x, y = self.midpoint()
